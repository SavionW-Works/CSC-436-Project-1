...
const Conversions = ({ rates2 }) => {
  //Given slightly different name to avoid major refactoring (again)
        ...
        <div className="container">
          <div className="row align-items-center justify-content-center">
            ...
            <div className="py-3">
              <button
                onClick={sortHandler}
                className="relative py-2 font-bold btn btn-primary rounded group"
              >
      ...
      <section id="Conversion Selectors" className="p-3">
        <div className="container">
          <div className="col align-items-center justify-content-center">
            <label for="Currency Dropdown" className="px-3 fs-3">
              {" "}
              Currency:{" "}
            </label>
            ...
            >
              {Object.keys(rates).map((curr) => {
                return (
                  <option value={curr} default="Currency">
                    {curr}
                  </option>
                );
              })}
            ...
            <label for="quantity" className="px-4 fs-3">
              Quantity:
            </label>
            <input
              type="number"
            ...
            {toggleExchange && (
              <p className="fs-3 pt-3">
                {" "}
                {rates[selectedCurrency] * selectedQuantity} BTC{" "}
              </p>
            )}
          </div>
        </div>
